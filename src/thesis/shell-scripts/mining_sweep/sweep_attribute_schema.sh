...
# live in scripts/mining_sweep/sweep_attribute_schema.py -- this file used to
...
#
# Usage:
#   src/thesis/shell-scripts/mining_sweep/sweep_attribute_schema.sh
#   src/thesis/shell-scripts/mining_sweep/sweep_attribute_schema.sh --workers 3
#
# Edit the grids in scripts/mining_sweep/sweep_attribute_schema.py, not here.
...
exec python "$REPO_ROOT/src/thesis/scripts/mining_sweep/sweep_attribute_schema.py" "$@"
