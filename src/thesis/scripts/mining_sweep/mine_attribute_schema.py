...
Usage:
  python src/thesis/scripts/mining_sweep/mine_attribute_schema.py fox wheeler harrison
  python src/thesis/scripts/mining_sweep/mine_attribute_schema.py --all --filtered naive50
  python src/thesis/scripts/mining_sweep/mine_attribute_schema.py cscas --train-frac 0.1 --test-frac 0.9
  python src/thesis/scripts/mining_sweep/mine_attribute_schema.py fox --force  # ignore cache, re-mine
  ...
  python src/thesis/scripts/mining_sweep/mine_attribute_schema.py cscas --mine-frac 0.1 --windowed
