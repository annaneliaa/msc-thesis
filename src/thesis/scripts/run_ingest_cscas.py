...
ingestion step. One basket per CSV row/signature (CSCAS_PREGROUPED_METHOD).
Run it once before any script that consumes cscas alert_groups.
...
Output:
    artifacts/cache/cscas/groups/cscas_pregrouped/alert_groups/alert_groups_raw.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="DIR",
        help="Output cache directory. Default: artifacts/cache/cscas/groups/cscas_pregrouped",
    )
