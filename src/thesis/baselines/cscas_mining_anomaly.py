...
# Delegates to the same shared set attribute_schema_cache's
# mine_or_reuse_attribute_schema now applies by default for scenario="cscas"
# (added 2026-09-13), so there's one definition of "which fields are CSCAS's
# own non-deployable oracle" instead of four.
